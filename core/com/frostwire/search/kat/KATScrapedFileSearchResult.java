 ...
 * @author aldenml
 */
public final class KATScrapedFileSearchResult extends AbstractCrawledSearchResult<KATSearchResult> implements TorrentSearchResult, TorrentScrapedFileSearchResult {
    ...
    public KATScrapedFileSearchResult(KATSearchResult sr, String filePath, long fileSize) {
        super(sr);
