...
public class TorrentDownloaderImpl extends AEThread implements TorrentDownloader {
 ...
 redirect_label:
	...
	*/
      ...
      directoryname = null;//COConfigurationManager.getDirectoryParameter("General_sDefaultTorrent_Directory");
      boolean useTorrentSave = false;//COConfigurationManager.getBooleanParameter("Save Torrent Files");
